...
if($encuesta->nuevaEncuesta($nombre,$descripcion_encuesta,$fecha_creacion,$comentario))
  {
      ...
      header("Location:verEncuestas.php");
...
<HEAD>
<TITLE>Encuestas | Sistema Conceptual | UNPA</TITLE>
...
<script type="text/javascript" src="java_script/calendar/calendar.js"></script>
    <script type="text/javascript" src="java_script/calendar/calendar-setup.js"></script>
    <script type="text/javascript" src="java_script/calendar/lang/calendar-es.js"></script>
    <style type="text/css"> @import url("java_script/calendar/calendar-win2k-cold-1.css"); </style>
...
<table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
                  <p><img src="imagenes/sistemaConceptual/logosmall.jpg" width="243" height="83" /></p>
                </td>
    <td><img src="imagenes/sistemaConceptual/asignacion.gif" width="60" height="60" align="right" /></td>
    |
  </tr>
</table>
...
<TABLE WIDTH="722" border=0 background="imagenes/enc_fondo.jpg">
	    ...
	    <TD width="716" ALIGN="left" valign="bottom" >
	      <p><a href="menu.php" class="AplicantesLink2">[Volver al Menu]</a>
	        <label>
	        </p>
	      <div align="center">
	        <p>
