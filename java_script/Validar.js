        ...
        case "maxlen": 
          { 
             ...
             { 
               if(!strError || strError.length ==0) 
               { 
                 strError = objValue.name + " : "+cmdvalue+" Minimos caracteres "; 
               }//if 
        ...
        case "minlen": 
           { 
             ...
             { 
               if(!strError || strError.length ==0) 
               { 
                 strError = objValue.name + " : " + cmdvalue + " Como minimimo  "; 
               }//if               
               alert(strError + "\n[Current length = " + objValue.value.length + " ]"); 
               return false;                 
             }//if 
        ...
        case "numeric": 
           { 
              ...
              { 
                if(!strError || strError.length ==0) 
                { 
                  strError = objValue.name+": Solo se Permiten digitos"; 
                }//if               
        ...
        case "alpha": 
           { 
              ...
              { 
                  if(!strError || strError.length ==0) 
                { 
                  strError = objValue.name+": Solo Caracters alphanumericos se permiten "; 
                }//if                             
                alert(strError + "\n [Error character position " + eval(charpos+1)+"]"); 
                return false; 
              }//if 
        ...
        case "email": 
          { 
               ...
               { 
                 if(!strError || strError.length ==0) 
                 { 
                    strError = objValue.name+": Ingrese Un Correo Valido "; 
                 }//if                                               
                 alert(strError); 
                 return false; 
               }//if 
